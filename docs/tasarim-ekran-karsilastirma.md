...
**Tasarımda:**
- Üst bar: Takyon Ai logosu · yuvarlak arama kutusu (kamera + mikrofon ikonlu) · rozetli mesaj ikonu — açık mavi zemin
...
**Tasarımda (`2.1 Login Screen`):** Takyon Ai logosu + "Merhaba" · **kullanıcı adı + şifre** (açık mavi hap şeklinde alanlar) · "Şifremi Unuttum" · lacivert "Giriş" butonu · "Hesabınız yok mu? Ücretsiz kayıt olun" · **Google / Facebook / LinkedIn ile giriş** · altta büyük illüstrasyon

  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['bottom']}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <TextField label="İplik Numarası (Tex)" keyboardType="numeric" value={tex} onChangeText={setTex} placeholder="Örn. 20" />
        <TextField label="İlmek Boyu (mm)" keyboardType="numeric" value={loopLength} onChangeText={setLoopLength} placeholder="Örn. 3.2" />
        <TextField label="K Faktörü" keyboardType="numeric" value={kFactor} onChangeText={setKFactor} placeholder="Örn. 13.3" />
